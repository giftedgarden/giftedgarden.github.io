# Gifted Garden launch checklist
...
- [ ] No family information, exports, secrets, or API keys exist in Git history.
...
- [ ] Repository, domain, forms, calendar, analytics, and email are business-controlled.
- [ ] At least two authorized administrators and recovery methods are documented.
- [ ] Availability has a weekly owner; hours, tuition, policies, and FAQ have a monthly owner.
- [ ] Uptime, broken-link, and recurring form-delivery checks notify a monitored business account.
